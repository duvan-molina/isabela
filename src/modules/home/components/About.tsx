...
const About = () => {
  return (
    <section id="sobre-isabela" className="py-8 md:py-24 bg-brand-soft overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          <motion.div
            ...
            className="w-full md:w-2/5 relative flex-shrink-0"
          >
            <div className="relative z-10 aspect-square rounded-[3rem] overflow-hidden shadow-[0_32px_64px_-15px_rgba(0,0,0,0.1)]">
              <img
